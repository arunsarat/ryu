...
class Switches(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        print "##### Setting Link Discovery to ={} #####".format(self.link_discovery)
        LOG.warning('##### Setting Link Discovery to %s', self.link_discovery)
    ...
    def lldp_loop(self):
        while self.is_active:
            ...
            for port in ports_now:
                print "#### lldp_loop ####Sending LLDP on port={}".format(port)
